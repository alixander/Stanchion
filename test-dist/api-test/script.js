...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_priorityqueue__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_request__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_constants_js__ = __webpack_require__(8);
...
class Stanchion {
  constructor(config = {}) {
    this.priorityQueue = new __WEBPACK_IMPORTED_MODULE_0_priorityqueue__["a" /* default */](__WEBPACK_IMPORTED_MODULE_1_request__["a" /* default */].getRequestComparator, 100);
    this.inflightCount = 0;
    this.logger = config.logger || noop;
  }

  queue(requestConfig) {
    const request = new __WEBPACK_IMPORTED_MODULE_1_request__["a" /* default */](requestConfig);
    this.logger({
      logLevel: __WEBPACK_IMPORTED_MODULE_2_constants_js__["a" /* default */].LogLevels.INFO,
  ...
  dispatch({task, onSuccess, onError, retryOption}) {
    ...
    task()
      ...
      .catch(error => {
        this.logger({
          logLevel: __WEBPACK_IMPORTED_MODULE_2_constants_js__["a" /* default */].LogLevels.ERROR,
...
/* harmony default export */ exports["a"] = {
  initialize,
  Constants: __WEBPACK_IMPORTED_MODULE_2_constants_js__["a" /* default */]
};
...
/* harmony default export */ exports["a"] = PriorityQueue;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_constants_js__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stanchion__ = __webpack_require__(10);



function main() {
  const network = __WEBPACK_IMPORTED_MODULE_1_stanchion__["a" /* default */].initialize({logger: console.log});
  ...
  for (let i = 0; i < requestNumber; i++) {
    const task = () => {
      return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/echo', {
        params: {
            message: `Call ${i}`
        }
      });
