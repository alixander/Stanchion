...
/* unused harmony export RetryOptions */
...
/* unused harmony export DEFAULT_MAX_OPEN_CONNECTIONS */

const DEFAULT_MAX_CONNECTIONS_PER_HOSTNAME = 6;
/* unused harmony export DEFAULT_MAX_CONNECTIONS_PER_HOSTNAME */
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ua_parser_js__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_constants_js__ = __webpack_require__(1);



const userAgentParser = new __WEBPACK_IMPORTED_MODULE_0_ua_parser_js___default.a();

let maxOpenConnections = __WEBPACK_IMPORTED_MODULE_1_constants_js__["a" /* default */].DEFAULT_MAX_OPEN_CONNECTIONS;
let maxOpenConnectionsPerHostname = __WEBPACK_IMPORTED_MODULE_1_constants_js__["a" /* default */].DEFAULT_MAX_CONNECTIONS_PER_HOSTNAME;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__priorityqueue__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__request__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__max_connections__ = __webpack_require__(2);
...
class Stanchion {
  constructor(config = {}) {
    ...
    this.maxOpenConnections = config.maxOpenConnections || __WEBPACK_IMPORTED_MODULE_4__max_connections__["a" /* default */].maxOpenConnections;
    this.maxOpenConnectionsPerHostname = config.maxOpenConnectionsPerHostname || __WEBPACK_IMPORTED_MODULE_4__max_connections__["a" /* default */].maxOpenConnectionsPerHostname;
  ...
  dispatch({task, onSuccess, onError, retryOption, hostname}) {
    ...
    task()
      ...
      .catch(error => {
        this.logger({
          logLevel: __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].LogLevels.ERROR,
...
(function (window, undefined) {
    ...
    if (typeof(exports) !== UNDEF_TYPE) {
        ...
        if ("function" === FUNC_TYPE && __webpack_require__(5)) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_constants_js__ = __webpack_require__(1);
...
class Request {
  constructor({
    ...
    hostname,
    priority = 1,
    retryOption = __WEBPACK_IMPORTED_MODULE_0_constants_js__["a" /* default */].RetryOptions.NONE,
    onSuccess = noop,
    onError = noop
  }) {
    if (!task) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__max_connections__ = __webpack_require__(2);


const getHostname = (url, parser) => {
  if (!url) {
    return null;
  }
...
const isBrowserSupported = () => {
  return __WEBPACK_IMPORTED_MODULE_0__max_connections__["a" /* default */].isBrowserSupported;
}
/* unused harmony export isBrowserSupported */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_stanchion__ = __webpack_require__(3);
